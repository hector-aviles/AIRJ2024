...
module_path = module_path + "/src/jifs2024/scripts/decision_models/"
...
def main(speed_left, speed_right):
    ...
    path = os.getcwd()
    file = path + "/src/jifs2024/scripts/decision_models/APClassifier_10.ap"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
       print("Usage: rosrun jifs2024 test_AP.py speed_left speed_right (m/s)", len(sys.argv))
    else:   
       try:
